...
urlpatterns = [
    ...
    path('weapon-banner/<pk>/delete', views.WeaponBannerDeleteView.as_view(), name='weapon_banner_delete'),
    path('weapon-banner/<pk>', views.WeaponBannerUpdateView.as_view(), name='weapon_banner_update'),
